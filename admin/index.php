        ...
        <fieldset>
            ...
            <label class="block mb-2">
                <input type="submit" name="btn_simpan" value="Simpan"
                    class="bg-blue-500 hover:bg-blue-700 hover:text-black text-white font-bold py-2 px-4 rounded" />
                <input type="reset" name="reset" value="Bersihkan"
                    class="bg-gray-500 hover:bg-gray-700 hover:text-black text-white font-bold py-2 px-4 rounded" />
            </label>
            <br>
...
function tampil_data($koneksi) {
    ...
    <tr class="hover-bg-change">
        ...
        <td class='py-3 px-4'>
            <a href="index.php?aksi=update&id=<?php echo $data['id']; ?>&nama_tanaman=<?php echo $data['nama_tanaman']; ?>&hasil_panen=<?php echo $data['hasil_panen']; ?>&hasil_penjualan=<?php echo $data['hasil_penjualan']; ?>&biaya_tanam=<?php echo $data['biaya_tanam']; ?>&lama=<?php echo $data['lama_tanam']; ?>&tanggal=<?php echo $data['tanggal_panen']; ?>"
                class="bg-gray-500 hover:bg-gray-700 text-white hover:text-black font-bold py-2 px-2 flex rounded">Ubah</a>
            |
            <a href="index.php?aksi=delete&id=<?php echo $data['id']; ?>"
                class="bg-red-500 hover:bg-gray-700 hover:text-black text-white font-bold py-2 px-2 flex rounded"">Hapus</a>
                </td>
            </tr>
        <?php
    }
...
function ubah($koneksi) {
    ...
    if (isset($_GET['id']) ) {
        ?>
            <a href=" index.php" class="bg-blue-500 text-white font-bold py-2 px-4 hover:text-black rounded">
                &laquo;
                Home</a> |
                ...
                <fieldset>
                    ...
                    <label class="block mb-2">
                        <input type="submit" name="btn_ubah" value="Simpan Perubahan"
                            class="bg-blue-500 hover:bg-blue-700 text-white hover:text-black font-bold py-2 px-4 rounded" />
                        atau <a href="index.php?aksi=delete&id=<?php echo $_GET['id'] ?>"
                            class="bg-red-500 py-2 px-4 rounded text-white font-bold hover:text-black"> Hapus data
                            ini</a>
                    </label>
                    <br>
                    <p class="text-red-500"><?php echo isset($pesan) ? $pesan : "" ?></p>
